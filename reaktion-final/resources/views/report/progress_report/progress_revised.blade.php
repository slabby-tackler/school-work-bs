<div class="revision">
	<p>
		<strong>To:</strong> World Wildlife Fund<br>
		<strong>From:</strong> Nicholas Wade<br>
		<strong>Subject:</strong> Changing people's Opinion as a Conservation Effort
	</p>
	...
	<div>
		...
		<ul>
			<li>New marketing using metaphor</li>
			<li>Demonstration of a fox as a pet</li>
		</ul>
	</div>
	...
	<div>
		...
		<ul>
			<li>Removing sexual connotations</li>
			<li>Discourage people from purchasing garments made with fox fur</li>
		</ul>
	</div>
